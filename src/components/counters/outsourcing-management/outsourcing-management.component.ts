...
export class OutsourcingManagementComponent {
  ...
  // Computed signal to enrich contracts with calculated values
  ...
  handleSave(contract: OutsourcingContract): void {
    if (this.selectedContract()) { // Editing
