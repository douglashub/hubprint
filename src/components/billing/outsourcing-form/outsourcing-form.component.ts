  ...
  constructor() {
    ...
    this.outsourcingForm.get('clientId')?.valueChanges.subscribe(clientId => {
        ...
        if (clientId) {
            ...
            if (client) {
                // Fix: Correctly map client franchise pages to form fields.
                this.outsourcingForm.patchValue({
                    includedPagesBw: client.franchise_pages_bw,
                    includedPagesColor: client.franchise_pages_color,
                    costPerPageBw: client.overage_cost_bw,
                    costPerPageColor: client.overage_cost_color,
                });
            }
        }
    });
